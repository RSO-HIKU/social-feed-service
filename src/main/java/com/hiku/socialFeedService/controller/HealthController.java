 ...
 * 
 * Endpoints:
 * - /api/feed/health        - Overall health status with detailed checks
 * - /api/feed/health/live   - Liveness probe (is the service running?)
 * - /api/feed/health/ready  - Readiness probe (is the service ready to receive traffic?)
 */
@Path("/health")
@ApplicationScoped
public class HealthController {
    ...
    public Response health() {
        ...
        JsonObject healthResponse = Json.createObjectBuilder()
                .add("status", status)
                .add("service", "social-feed-service")
